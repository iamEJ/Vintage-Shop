...
public class StoreApplication implements CommandLineRunner
{
	...
	public void run(String... args) throws Exception {
		...
		Product p9 = new Product("Vintage Phone","Aliquam finibus enim vel blandit sodales. In in odio ligula. Ut placerat neque nec varius ultricies. Suspendisse quis consectetur ex. Suspendisse faucibus, turpis id feugiat molestie, odio eros congue odio, eu iaculis purus sapien et arcu. ", 600.99, "https://i.pinimg.com/originals/bf/ff/95/bfff95301aa37f717f2849d12762966d.jpg",false,true,Category.PHONE);
